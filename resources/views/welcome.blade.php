...
@section('content')
<div class="header header-filter" style="background-image: url('{{ asset('img/lab_quimico.jpg') }}')">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h1 class="title">Instituto de Salud Publica de Chile</h1>
                <h4>En esta pagina podras registrar tus muestras medicas</h4>
                <br />
